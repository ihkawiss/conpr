...
class ConprBank implements Bank {
	...
	private Map<String, ConprAccount> accounts = new ConcurrentHashMap<String, ConprAccount>();
...
class ConprAccount implements bank.Account {
	...
	@Override
	// critical - lock deposit on same object using synchronized(this)
	...
	@Override
	// critical - lock withdraw on same object using synchronized(this)
